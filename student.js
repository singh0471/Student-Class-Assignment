class Student {
    ...
    static newStudent(firstName, lastName, dob, semesterCGPA, yearOfEnrollment, yearOfPassing) {
        try {
            ...
            if (typeof yearOfEnrollment !== "string") throw new Error("Enter a valid year of enrollment");
            if (typeof yearOfPassing !== "string") throw new Error("Enter a valid year of passing");
